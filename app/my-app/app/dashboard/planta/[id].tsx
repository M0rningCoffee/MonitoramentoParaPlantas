...
export default function PlantaDetalhe() {
  ...
  if (!planta) {
    return (
      <View style={styles.container}>
        <Text style={{ color: colors.white, fontSize: 18, marginTop: 50 }}>Planta não encontrada ou erro de comunicação com a API!</Text>
      </View>
    );
  }
      ...
      <View style={styles.card}>
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>{planta.umidade_minima ?? 'N/A'}%</Text>
          </View>
          <View style={styles.infoBox}>
            <Text style={styles.infoTitle}>Último Registro</Text>
            {/* 💡 Exibindo o último log (ou N/A) */}
            <Text style={styles.infoText}>
                {planta.logs.length > 0 ? new Date(planta.logs[0].created_at).toLocaleTimeString() : 'N/A'}
            </Text>
          </View>
        </View>
